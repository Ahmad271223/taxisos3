...
export function bookingDTO(b: any, extra: Record<string, any> = {}) {
  return {
    ...
    card: b.card ? { id: b.card.id, brand: b.card.brand, last4: b.card.last4 } : null,
    tipPromptedAt: b.tipPromptedAt ?? null,
    ...
    // Fahrer-Rueckfrage 30 Min vor der Abholung (Ja/Nein + Storno-Button)
    driverConfirmAskedAt: b.driverConfirmAskedAt ?? null,
    driverConfirmedAt: b.driverConfirmedAt ?? null,
    driverDeclinedAt: b.driverDeclinedAt ?? null,
    reassignCount: b.reassignCount ?? 0,
    isSos: b.isSos ?? false,
